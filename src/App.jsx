  ...
  return (
    <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="px-5 py-4 border-b border-slate-200 bg-gradient-to-r from-slate-900 to-slate-800 flex items-center justify-between">
        ...
        <div className="p-5 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-slate-900">{user.name || 'Unknown User'}</div>
              <div className="text-xs text-slate-500">{user.designation || 'No designation'}</div>
            </div>
          </div>

          <div className="grid grid-cols-1 gap-3">
            <div className="border border-slate-200 rounded-lg p-3">
              <div className="text-[11px] uppercase tracking-wide text-slate-500 font-semibold mb-1">Department</div>
              <div className="text-sm text-slate-800">{user.dept || 'N/A'}</div>
            </div>
            <div className="border border-slate-200 rounded-lg p-3">
              <div className="text-[11px] uppercase tracking-wide text-slate-500 font-semibold mb-1">Employee ID</div>
              <div className="text-sm text-slate-800">{user.empId || 'N/A'}</div>
            </div>
            <div className="border border-slate-200 rounded-lg p-3">
              <div className="text-[11px] uppercase tracking-wide text-slate-500 font-semibold mb-1">Email</div>
              <div className="text-sm text-slate-800">{user.email || 'N/A'}</div>
            </div>
            <div className="border border-slate-200 rounded-lg p-3">
              <div className="text-[11px] uppercase tracking-wide text-slate-500 font-semibold mb-1">Phone</div>
              <div className="text-sm text-slate-800">{user.phone || 'N/A'}</div>
            </div>
          </div>
        </div>
